...
class   FaceliftController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        ## API Information
        $api_information = [
            'token' => "IKeWUOebU4pPorAqxq3eKE6ZAWOr4vTkYXke71Ft",
    ...
    public function home()
    {
        ...
        $this->data['landing_slug'] = 'facelift';
        $this->data['service'] = 'Facelift';
        ...
        if ($this->data['userLocale'] == 'en') {
            $faqs = [
                ["question" => "Are the results of the facelift surgery permanent?", "answer" => "Yes, they are."],
                ["question" => "Will it leave scars?", "answer" => "The incision line for the facelift surgery starts from the skin under the hair, follows the skin tissues in front of the ears and turns to the back of the ears and ends in the haired skin. Most of the scars will be hidden by the haired skin, the rest will be hidden by the natural curves and lines of the face."],
                ["question" => "What should I pay attention to before and after the surgery?", "answer" => "-Patients need to stop smoking 15 days before the surgery and should not smoke until one month after the surgery. Patients who regularly take aspirin should stop taking it 10 days before the surgery."],
                ["question" => "Would there be pain after the Facelift surgery?", "answer" => "-As is the case with all surgical operations, slight pain is felt for a day or two after the surgery. However, pain killers given to the patient after the surgery will be effective in relieving the pain. There will be swelling and/or bruise after the surgery."],
                           ];
            $testimonials = [
