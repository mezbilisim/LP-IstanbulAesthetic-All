...
function showWheel(duration) {
    $('.wheel-overlay').css('display', 'block')
    $('.wheel-overlay').transition({
        opacity: '1'
    }, duration);

    $(".wheel_content").show();
    $(".wheel_content").transition({
        left: '+=1500px'
    }, duration);
...
function hideWheel(duration) {
    $('.wheel-overlay').transition({
        opacity: '0',
    }, duration);
    $('.wheel-overlay').css('display', 'none')
