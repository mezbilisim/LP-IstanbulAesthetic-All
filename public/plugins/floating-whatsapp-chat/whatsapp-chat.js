    ...
    multipleUser :function(options){
        ...
        if(settings.selector != ''){
            ...
            settings.users.forEach(function (user, index){
                ...
                userList +='<li class="item rs-go-to-whatsapp gtm-whatsapp fb-whatsapp '+active+'" data-userId="'+index+'">'+
            ...
            if(element !=null){
                var chatBox = '<div class="ayoan_whatsapp_chatbox_container">' +
                    ...
                    '<img class="header-icon" src="../plugins/floating-whatsapp-chat/assets/whatsapp.svg"> </div><div class="col col-2">' +
                    ...
                    '<img class="icon" src="../plugins/floating-whatsapp-chat/assets/close.svg"></button></div></div>' +
                    '<div class="rs-openChatBtn widget-close-btn-row" >' +
                    '<button type="button" class="rs-openChatBtn widget-close-btn custom-animate-button">' +
                    '<img class="icon" src="../plugins/floating-whatsapp-chat/assets/whatsapp.svg"></button></div></div>';
